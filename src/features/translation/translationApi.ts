...
export function saveTranslationText(text: string, targetLanguage: string, locale: 'ko' | 'en'): Promise<SaveTranslationResult> {
  return invoke<SaveTranslationResult>('save_translation_text', { text, targetLanguage, locale });
}
